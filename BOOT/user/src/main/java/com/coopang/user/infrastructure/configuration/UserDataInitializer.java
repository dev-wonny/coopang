...
public class UserDataInitializer implements CommandLineRunner {
    ...
    // 고정된 uuid
    String[] fixedUuids = {
        "3e864e21-15c8-47e1-b3b3-c669abf7f0fa",//master1
        "40d78eb3-ca15-44ac-a5b5-182830615f4f",//master2
        "e73eb204-8f6e-4c61-8a5f-5df1c0a2797e",//master3
        "a96f086f-87cf-4c7d-99e8-1c31db14ca5e",//master4
        ...
        "55de6337-556d-43c6-adbf-469c2cf2dea9",//ULSAN
        "e8c54e27-92cc-4780-a4d9-2ada1a577a34",//SEJONG
        "aa2a4b10-c91e-4993-8e28-a907602f13d2",//GANGWON
        "239f11df-4280-43b4-81a4-7139b31b071b",//CHUNGBUK
        "3a1386db-8ad3-4cac-a234-31925ada139b",//ShipperHub-서울
        ...
        "ef88eab0-66a3-43fd-894b-5e3d1bbfc348",//ShipperCustomer 1 - 강원
...
//            "62c5850e-005f-47ae-8f0f-559df09fe681"
    ...
    private void createMasterUsers() {
        for (int i = 1; i <= 4; i++) {
            UserDto masterDto = UserDto.of(
                getNextFixedUuid()
                , "master" + i + COOPANG_EMAIL
                , COOPANG_LOWERCASE
                , "Master" + i
                , "010-1111-1111"
    ...
    private void createHubManagers() {
        ...
        for (int i = 0; i < hubRegions.length; i++) {
            UserDto hubManagerDto = UserDto.of(
                getNextFixedUuid()
                , "HubManager" + (i + 1) + COOPANG_EMAIL
                , COOPANG_LOWERCASE
                , "HubManager" + (i + 1)
                , "010-1111-1111"
    ...
    private void createCustomers() {
        ...
        for (int i = 0; i < hubRegions.length; i++) {
            ...
            UserDto customerDto = UserDto.of(
                getNextFixedUuid()
                , "customer_" + hubName + COOPANG_EMAIL
                , COOPANG_LOWERCASE
    ...
    private void createShipperUsers() {
        ...
        for (int i = 0; i < hubRegions.length; i++) {
            ...
            // Shipper Hub 생성
            UserDto shipperHubDto = UserDto.of(
                getNextFixedUuid()
                , "shipperHub_" + hubName + COOPANG_EMAIL
                , COOPANG_LOWERCASE
            ...
            for (int j = 1; j <= 2; j++) {
                UserDto shipperCustomerDto = UserDto.of(
                    getNextFixedUuid()
                    , "shipperCustomer_" + j + "_" + hubName + COOPANG_EMAIL
                    , COOPANG_LOWERCASE
    ...
    private void createCompanyUsers() {
        ...
        for (int i = 0; i < hubRegions.length; i++) {
            ...
            for (int j = 1; j <= 2; j++) {
                UserDto companyDto = UserDto.of(
                    getNextFixedUuid()
                    , "company" + j + "_" + hubName + COOPANG_EMAIL
                    , COOPANG_LOWERCASE
