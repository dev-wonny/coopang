...
import com.coopang.order.application.service.order.IOrderService;
...
public class OrderKafkaConsumer {
    ...
    private final IOrderService iOrderService; // 수정된 내용
    private final MessageSender messageSender; // 삭제 예정
