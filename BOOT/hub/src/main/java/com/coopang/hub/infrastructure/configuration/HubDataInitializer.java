...
public class HubDataInitializer implements CommandLineRunner {
    ...
    private void createHubs() {
        createHub("서울특별시 센터", "서울특별시 송파구 송파대로 55", "11111", SEOUL, UUID.fromString("d55c8cdb-760d-4dd3-ac77-c30d2cbf787d"), UUID.fromString("12fc1d66-4270-4468-b76d-93264856327b"));
        createHub("경기 북부 센터", "경기도 고양시 덕양구 권율대로 570", "11111", GYEONGGI_NORTH, UUID.fromString("4e1d9435-820a-432e-abe3-b7a11c0fbeea"), UUID.fromString("4dd1bc35-fecf-40a6-a3cd-281a6a800752"));
        createHub("경기 남부 센터", "경기도 이천시 덕평로 257-21", "11111", GYEONGGI_SOUTH, UUID.fromString("7a612c48-3c7c-4333-a54c-032400745cf6"), UUID.fromString("83f3e5ab-adda-4d53-adb1-bf2e00f80af6"));
        createHub("부산광역시 센터", "부산 동구 중앙대로 206", "11111", BUSAN, UUID.fromString("3a5ed5e5-8ee1-42c2-b201-9949a99f6b72"), UUID.fromString("83004b5d-122a-4bab-a27c-78824da0ad77"));
        createHub("대구광역시 센터", "대구 북구 태평로 161", "11111", DAEGU, UUID.fromString("0008e5b7-b5a6-41f2-8e3c-29156039a642"), UUID.fromString("d25e0314-0b9d-47dc-8a35-afd4381d3a9e"));
        createHub("인천광역시 센터", "인천 남동구 정각로 29", "11111", INCHEON, UUID.fromString("249196ce-33df-4f86-a46d-9d42fead886b"), UUID.fromString("094f9450-8916-4d5d-872f-af929cba79f7"));
        createHub("광주광역시 센터", "광주 서구 내방로 111", "11111", GWANGJU, UUID.fromString("8fccf12a-13db-4e8e-9a2c-cbf85cb24a04"), UUID.fromString("297e573f-a450-46c4-b0ac-3d318ae66e27"));
        createHub("대전광역시 센터", "대전 서구 둔산로 100", "11111", DAEJEON, UUID.fromString("ddab89d6-a024-43aa-b6a1-826110786686"), UUID.fromString("f2bea779-3987-474b-a044-d707551ad689"));
