...
public class ProductStockHistoryController {
    ...
    public ResponseEntity<Page<ProductStockHistoryResponseDto>> getStockHistoriesByProductIdWithCondition(
        @RequestBody ProductStockHistorySearchConditionDto condition
